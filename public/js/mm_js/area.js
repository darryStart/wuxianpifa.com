...
function docheck() {
    if (add_address.user_name.value == "") {
      layer.open({
          content: '请填写收货人姓名'
          ,skin: 'msg'
          ,time: 2
      ...
      return false;
    } else if (add_address.mobile.value == "") {
      layer.open({
          content: '请填写收货人手机号码'
          ,skin: 'msg'
          ,time: 2
      ...
      return false;
    }else if(add_address.s_province.value == "-- 选择 --"){
      layer.open({
          content: '请选择所在省份'
          ,skin: 'msg'
          ,time: 2
      ...
      return false;
    }else if(add_address.s_city.value == "-- 选择 --"){
      layer.open({
          content: '请选择所在市'
          ,skin: 'msg'
          ,time: 2
      ...
      return false;
    }else if(add_address.s_county.value == "-- 选择 --"){
      layer.open({
          content: '请选择所在区/县'
          ,skin: 'msg'
          ,time: 2
      ...
      return false;
    }else if (add_address.address.value == "") {
      layer.open({
          content: '请填写详细的收货地址'
          ,skin: 'msg'
          ,time: 2
