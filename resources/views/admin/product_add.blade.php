...
<form action="" method="post" class="form form-horizontal" id="form-product-add">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-5">
            <input type="text" class="input-text" style="width: 93%;" value="999" placeholder="" name="price"  datatype="*" nullmsg="价格不能为空">&nbsp;&nbsp;(元)
        </div>
        <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-5 ">
            <input type="text" class="input-text" value="0"  class="layui-input"  placeholder="" name="sales_num"  datatype="*" nullmsg="销售量不能为空">
        </div>
        <div class="col-4"> </div>
    </div>
    <div class="row cl">
        <label class="form-label col-2"><span class="c-red">*</span>批发件：</label>
            <div class="formControls col-5">
                <input type="number" class="input-text" value="999" placeholder="" name="trade[num][]"  datatype="*" nullmsg="批发件不能为空">
                <input type="number" class="input-text" value="999" placeholder="" name="trade[num][]"  datatype="*" nullmsg="批发件不能为空">
                <input type="number" class="input-text" value="999" placeholder="" name="trade[num][]"  datatype="*" nullmsg="批发件不能为空"> &nbsp;&nbsp;(件)
            </div>
        <div class="col-4"> </div>
    </div>
    <div class="row cl">
        ...
        <div class="formControls col-5">
            <input type="text" class="input-text" style="width: 80px" value="999" placeholder="" name="trade[price][]"  datatype="*" nullmsg="价格不能为空">
            <input type="text" class="input-text" style="width: 80px" value="999" placeholder="" name="trade[price][]"  datatype="*" nullmsg="价格不能为空">
            <input type="text" class="input-text" style="width: 80px" value="999" placeholder="" name="trade[price][]"  datatype="*" nullmsg="价格不能为空">&nbsp;&nbsp;(元)
        </div>
        <div class="col-4"> </div>
    </div>
